	...
	<x-slot:title>
		...
		<div class="px-5 mt-5 mb-10">
			<div class="flex items-center justify-between">
				<h1 class="block mt-5 text-3xl font-semibold text-center">All Article</h1>
				<a href="/" class="block mt-5 text-2xl font-semibold text-center duration-100 border-b-2 border-black hover:translate-x-2 w-fit">Newest Article</a>
			</div>
			@if($posts->isEmpty())
