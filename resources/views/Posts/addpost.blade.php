<x-admin-navbar>
	...
	<form action="/myPosts" method="POST" enctype="multipart/form-data">
		...
		<div class="grid grid-cols-2 gap-3 text-center">
			...
			{{-- <button  class="px-3 py-2 duration-100 rounded bg-cyan-600 text-slate-200 hover:bg-cyan-700 hover:text-slate-300 hover:scale-95">Insert Data Article</button> --}}
		</div>
	</form>
	<script>
